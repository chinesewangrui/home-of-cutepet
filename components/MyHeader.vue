...
.container-fluid>.hupper>.huptxt{line-height:2.5rem;margin:0 auto;color:#833535;}
.container-fluid>.hupper>.hupleft{line-height:2.5rem;margin:0}
.container-fluid>.hupper>.hupleft>.hupul{padding:0;margin:0;margin-right:9.4rem;}
.container-fluid>.hupper>.hupleft>.hupul>.hupline{margin:0 1.25rem;}
...
/* 中部分css */
.hbet>.hbetlogo .logo{width:5rem;margin-left:6rem;cursor: pointer;}
...
.hdown>.hdownul>.hdownli{line-height:3rem;}
.hdown>.hdownul{
    align-items:center;
    display:flex;
